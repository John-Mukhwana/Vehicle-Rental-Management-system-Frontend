...
const VehicleManagement: React.FC = () => {
  ...
  const fetchVehicles = async () => {
    try {
      const response = await axios.get('https://exotravel-vehicle-rental-management.onrender.com/api/vehicles', {
        headers: {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const updateUrl = `https://exotravel-vehicle-rental-management.onrender.com/api/vehicles/${selectedVehicleId}`;
